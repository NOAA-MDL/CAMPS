...
def read(*filenames):
    ...
    for filename in filenames:
        ...
        procedures, variables_dict = separate_procedure_and_data(variables_dict)
        times, variables_dict = separate_time_and_data(variables_dict)
        coordinates, variables_dict = separate_coordinate_and_data(variables_dict)
...
def create_wisps_data(nc_variable, procedures_dict, time_dict, coordinate_dict):
    ...
    coordinate = get_coordinate(nc_variable, coordinate_dict)
