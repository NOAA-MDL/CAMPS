...
class station:
    ...
    def add_record(self, observation_keys, values, hour, new=False):
        ...
        for ob, datum in zip(observation_keys, values):
            datum = datum.strip()
            # Assigns the function that will handle
            # special-case string observations.
    ...
    def add_empty_record(self, index, hour):
        ...
        This will give MISSING values too obersvations for the given hour.
        """
    ...
    def fill_empty_records(self, start=None, end=None, delta=None):
        ...
        while start <= end:
            try:
                ...
                # add an empty record to the end
