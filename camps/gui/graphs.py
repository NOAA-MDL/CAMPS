...
def main():
    ...
    if control_file is not None:
        ctrl = cfg.read_control(control_file)
    ...
    def corr_table(data,variables):
        ...
        #--------------------------------------------------------------------------
        arr = data.loc[:,variables]
        arr.corr().to_csv(ctrl.output_file_path+'correlation'+suffix+'.csv')
    ...
    if ctrl.all_corr == True:
        ...
        scatter_matrix(data,ctrl.corr_vars,ctrl.scatt_matrix_names,ctrl.show,ctrl.save)
