    ...
    for i, (vis, wx_1, wx_2, wx_3) in enumerate(zip(
            ...
            if vis > 100 or vis < 0:
                errors.append(
                    qc_error(
                        ...
                        explanation="visibility out of range"
                    ))
                ...
                errors.append(
                    qc_error(
                        ...
                        new_data_value=6,
                        explanation="visibility should "
                        "be reduced based on weather "
                ...
                errors.append(
                    qc_error(
                        ...
                        new_data_value=MISSING_VALUE,
                        explanation="visibility too large based on weather "
                        "conditions:" + str(all_wx)
                    ))
                visibility[i] = MISSING_VALUE
                ...
                errors.append(
                    qc_error(
                        ...
                        new_data_value=10,
                        explanation="Fog reported, but visibility > .5"
                    ))
                ...
                errors.append(
                    qc_error(
                        ...
                        new_data_value=10,
                        explanation="Mist reported, but visibility < .5"
                    ))
                ...
                if vis > .25 and vis <= .50:
                    ...
                    errors.append(
                        qc_error(
                            ...
                            new_data_value=present_wx[0][i],
                            explanation="Intensity of light snow/drizzle "
                ...
                if vis > .50:
                    ...
                    errors.append(
                        qc_error(
                            ...
                            error_code=9214, old_data_value=wx_1 - 2,
                            new_data_value=present_wx[0][i],
                            explanation="Intensity of moderate "
                            "snow/drizzle reported does not match"
                            " visibility (" + str(vis) +
                            ") reported, and no other weather was reported" +
                            str(all_wx)
                        ))
                ...
                if vis > .50:
                    ...
                    errors.append(
                        qc_error(
                            ...
                            error_code=9214, old_data_value=wx_1,
                            new_data_value=present_wx[0][i],
                            explanation="Intensity of heavy snow/drizzle " +
                            "reported does not match"
                            " visibility (" + str(vis) +
                            ") reported, and no other weather was reported" +
                            str(all_wx)
                    ...
                    errors.append(
                        qc_error(
                            ...
                            new_data_value=present_wx[0][i],
                            explanation="Intensity of heavy "
                            "snow/drizzle reported does not match"
                            " visibility (" + str(vis) +
                            ") reported, and no other weather was reported" +
                            str(all_wx)
        ...
        if is_precipitation(wx_2) and is_hydrometeor(wx_1):
            ...
            errors.append(qc_error(
                ...
                new_data_value=wx_1,
                explanation="Order of weather is incorrect. "
        ...
        if is_present(all_wx, is_precipitation) and 16 in all_wx:
            ...
            errors.append(
                qc_error(
                    ...
                    new_data_value=wx_3,
                    explanation="Showers within sight reported "
        ...
        if is_tstorm(wx_1) and wx_2 == 96:
            errors.append(
                qc_error(
                    ...
                    new_data_value=90,
                    explanation="thunderstorm reported in group 1 "
        ...
        if dupe_found:
            errors.append(
                qc_error(
                    ...
                    new_data_value=present_wx[1][i],
                    explanation="Duplicate weather group found"
                ))
        dupe_found = False
        ...
        if is_present(all_wx, should_not_exist_below_30) \
            ...
            errors.append(
                qc_error(
                    ...
                    new_data_value=MISSING_VALUE,
                    explanation="Temperature is less than 30 "
                    "and reported weather is"
            ...
            errors.append(
                qc_error(
                    ...
                    new_data_value=MISSING_VALUE,
                    explanation="Temperature is greater than 40 and reported "
            ...
            errors.append(
                qc_error(
                    ...
                    new_data_value=MISSING_VALUE,
                    explanation="blowing phenomenon is reported  "
        ...
        if cloud_amount[i] == 10 and wx_1 == 0  \
            ...
            errors.append(
                qc_error(
                    ...
                    new_data_value=MISSING_VALUE,
                    explanation="cloud height reported as obstructed, but "
            ...
            errors.append(
                qc_error(
                    ...
                    new_data_value=MISSING_VALUE,
                    explanation="Clear Skys reported, but "
