...
def convert_grib2(control):
    ...
    #---------------------------------------------------------------------------
    # Save temporary grb to easily access shared information
    #---------------------------------------------------------------------------
    grbs.seek(0)
    tmp_grb = grbs.next()
    ...
    # Append variable data together by leadtime for easy stacking later
...
def sort_by_lead_time(grbs,max_lead_times):
    """Given a collection of gribs, sort by lead time.
